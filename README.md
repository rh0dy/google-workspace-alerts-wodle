...
This wodle allows security teams to monitor security alerts raised in [Google Workspace Alert Center](https://workspace.google.com/intl/en_uk/products/admin/alert-center/) through their existing [Wazuh](https://wazuh.com/) deployment.
